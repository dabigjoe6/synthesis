const generateEmailTemplateNew = (posts) => {
  if (posts && posts.length > 0) {
    let postsHTML = "";

    posts.forEach((post) => {
      postsHTML += `<table style="font-family:trebuchet ms,geneva;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px;font-family:trebuchet ms,geneva;" align="left">
                                ...
                                <h4 class="v-text-align v-line-height" style="margin: 0px; line-height: 100%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 16px;"><strong>${post.title}</strong></h4>
                            ...
                            <tr>
                              <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 0px 0px 10px;font-family:trebuchet ms,geneva;" align="left">
                                ...
                                <div class="v-text-align v-line-height" style="line-height: 110%; text-align: left; word-wrap: break-word;">
                                  <p style="font-size: 14px; line-height: 110%;"><a rel="noopener" href="${post.url}" target="_blank">Read more</a></p>
                                </div>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                      <a href="http://morningbrewstaging.netlify.app" target="_blank">
                                        <img align="center" border="0" src="https://assets.unlayer.com/projects/119809/1670675165954-morning.png" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 27%;max-width: 129.6px;"
                                          width="129.6" />
                                      </a>
                                    </td>
                                  </tr>
                          ...
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:trebuchet ms,geneva;" align="left">
                                ...
                                <h1 class="v-text-align v-line-height" style="margin: 0px; line-height: 100%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Cabin',sans-serif; font-size: 19px;">Today's digest</h1>
                          ...
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:trebuchet ms,geneva;" align="left">
                                ...
                                <h1 class="v-text-align v-line-height" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-size: 9px;"><a rel="noopener" href="https://morningbrewstaging.netlify.app" target="_blank">Too many emails? Change email frequency</a></h1>
...
export default generateEmailTemplateNew;
